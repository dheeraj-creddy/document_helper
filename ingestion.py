...
from langchain_chroma import Chroma #for local
...
embeddings = OpenAIEmbeddings(
    ...
    chunk_size=50,
    retry_min_seconds=10, #rate limiting
)

#vectorstore = Chroma(persist_directory="chroma_db", embedding_function=embeddings)
vectorstore = PineconeVectorStore(index_name="document-helper", embedding=embeddings )
...
async def main():
    ...
    res = tavily_crawl.invoke(
        {
            "url": "https://www.lg.com/us/support", #change to required website to scrape
            #  https://www.lg.com/us/
            "max_depth": 2,
